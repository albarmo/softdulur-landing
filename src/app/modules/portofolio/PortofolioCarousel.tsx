...
import { Carousel } from '@/material-tw/carousel';
        ...
        <>
            <div className='px-40 py-10 gradient-2 h-auto'>
                ...
                <div className="flex justify-between items-center">
                    <section aria-label='left' className="relative w-3/6 z-10flex flex-col items-left justify-center h-full leading-1">
